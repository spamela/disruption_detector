...
;copy of disruption efit 10 - re run to collect all of the missed ohmic discharges

q=where(use_260610 eq 1 and shots ne 22228)
...
if(index gt 13668 or n_elements(findmax_dsrtimepoint) eq 0) then begin
	sxr_90pc=-2
	print, 'Problem'
	goto, garbage
endif else begin 
